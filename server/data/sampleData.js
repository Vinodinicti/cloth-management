...
export const sampleStitchingOrders = [
  {
    id: "STITCH-1001",
...
export const sampleActivities = [
  { id: "ACT-01", time: "10 minutes ago", text: "New stitching order #STITCH-1001 created for Ananya Sharma", icon: "scissors", type: "stitching" },
  { id: "ACT-02", time: "35 minutes ago", text: "Stock updated: Banarasi Raw Silk Roll (+25 meters added)", icon: "package", type: "stock" },
  { id: "ACT-03", time: "2 hours ago", text: "Order #ORD-8803 payment confirmed via NetBanking (INR 8,600)", icon: "credit-card", type: "payment" },
  { id: "ACT-04", time: "4 hours ago", text: "Master Ramesh updated #STITCH-1002 status to IN PROGRESS", icon: "clock", type: "stitching" },
  { id: "ACT-05", time: "Yesterday", text: "Customer Rohan Kapoor profile updated with summer measurement notes", icon: "user", type: "customer" }
];
